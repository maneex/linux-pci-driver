...
>
> **Le moment est contraint** : l'annonce se fait quand les **deux vrings de vdev0 sont
> `VQ_ENABLE`**, pas à `FW_STATUS = 2`. Plus tôt, les anneaux n'existent pas encore côté
> Linux et le message part dans le vide (§5).
>
